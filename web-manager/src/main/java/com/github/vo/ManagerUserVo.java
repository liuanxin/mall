...
public class ManagerUserVo {
    ...
    public static ManagerUserVo testData() {
        ...
        List<ManagerMenuVo> commonList = Arrays.asList(
        ...
        menus.add(new ManagerMenuVo().setName("公共管理").setFront("common").setChildren(commonList));

        List<ManagerMenuVo> userList = Arrays.asList(
        ...
        menus.add(new ManagerMenuVo().setName("用户管理").setFront("user").setChildren(userList));

        List<ManagerMenuVo> orderList = Arrays.asList(
        ...
        menus.add(new ManagerMenuVo().setName("商品管理").setFront("product").setChildren(orderList));

        List<ManagerMenuVo> productList = Arrays.asList(
                new ManagerMenuVo().setName("订单列表").setFront("order-index"),
                new ManagerMenuVo().setName("添加订单").setFront("order-add"),
                new ManagerMenuVo().setName("编辑订单").setFront("order-edit")
        );
        menus.add(new ManagerMenuVo().setName("订单管理").setFront("order").setChildren(productList));

        List<ManagerMenuVo> managerList = Arrays.asList(
        ...
        menus.add(new ManagerMenuVo().setName("系统管理").setFront("manager").setChildren(managerList));
