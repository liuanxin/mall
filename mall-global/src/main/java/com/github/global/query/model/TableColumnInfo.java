...
public class TableColumnInfo {
    ...
    public TableColumnInfo(Map<String, String> aliasMap, Map<String, Table> tableMap, List<TableColumnRelation> relationList) {
    ...
    public Table findTable(String tableName) {
        String tableAlias = aliasMap.get(QueryConst.SCHEMA_PREFIX + tableName);
    ...
    public Map<String, TableColumnRelation> findRelationByMaster(String masterTable) {
        ...
        String tableAlias = aliasMap.get(QueryConst.SCHEMA_PREFIX + masterTable);
    ...
    private TableColumnRelation findRelation(Map<String, Map<String, TableColumnRelation>> tableRelationMap,
        ...
        String tableAlias = aliasMap.get(QueryConst.SCHEMA_PREFIX + table);
