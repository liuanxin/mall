...
public final class U {
     ...
     *
     * 纯计算型: CPU 密集型
     *     配置尽可能小的线程数, 如配置 CPU 数 + 1 个线程
     *     (当发生未知原因而暂停时, 刚好有 1 个"额外"的线程可以确保在这种情况下 CPU 周期不会中断工作)
     *
     ...
     * -------------------------------------------------------------------------
     *
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.7, CPU 时间:  10, IO 时间:  190 ==> 56
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.7, CPU 时间:  20, IO 时间:  180 ==> 28
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.7, CPU 时间: 100, IO 时间:    1 ==>  3
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.7, CPU 时间: 999, IO 时间:    1 ==>  3
     *
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.75, CPU 时间:  10, IO 时间:  190 ==> 60
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.75, CPU 时间:  20, IO 时间:  180 ==> 30
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.75, CPU 时间: 100, IO 时间:    1 ==>  4
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.75, CPU 时间: 999, IO 时间:    1 ==>  4
     *
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.8, CPU 时间:  10, IO 时间:  190 ==> 64
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.8, CPU 时间:  20, IO 时间:  180 ==> 32
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.8, CPU 时间: 100, IO 时间:    1 ==>  4
     * 有 4 个 CPU 核心, CPU 利用率想到达到  0.8, CPU 时间: 999, IO 时间:    1 ==>  4
     *
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.85, CPU 时间:  10, IO 时间:  190 ==> 68
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.85, CPU 时间:  20, IO 时间:  180 ==> 34
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.85, CPU 时间: 100, IO 时间:    1 ==>  4
     * 有 4 个 CPU 核心, CPU 利用率想到达到 0.85, CPU 时间: 999, IO 时间:    1 ==>  4
     * </pre>
     *
