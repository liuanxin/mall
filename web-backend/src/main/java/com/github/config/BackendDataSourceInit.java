...
public class BackendDataSourceInit {
    ...
    public BackendDataSourceInit(@Qualifier("dataSource") DataSource dataSource) {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        // 装载 xml 实现
        sessionFactory.setMapperLocations(BackendConfigData.RESOURCE_ARRAY);
        // 装载 typeHandler 实现
        sessionFactory.setTypeHandlers(BackendConfigData.HANDLER_ARRAY);
        // mybatis 的分页插件
